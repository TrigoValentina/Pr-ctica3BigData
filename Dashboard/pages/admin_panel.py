...
if decoded.get("role") != "admin":
    st.error("Acceso denegado. Solo el administrador puede acceder aquí.")
    st.stop()
...
st.markdown(
    """
<style>
    /* Botón logout rojo arriba a la derecha */
    .top-bar {
        display: flex;
...
if "delete_user" in st.session_state:
    ...
    st.error(f"¿Eliminar DEFINITIVAMENTE al usuario **{d['Nombre']}**?")
